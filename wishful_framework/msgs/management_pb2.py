...
_NEWNODEMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='interfaces', full_name='wishful_controller.framework.NewNodeMsg.interfaces', index=4,
